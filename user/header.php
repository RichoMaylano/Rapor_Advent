      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboards -->
            <li class="menu-item <?php if($title == "Dashboard | Aplikasi Pengumuman Kelulusan"){ echo 'active'; } ?>">
          ...
          <nav
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                ...
                <span class="demo menu-text fw-bold mt-1 ms-6"><i class='bx bx-bell mb-1'></i> &nbsp Selamat Datang di Aplikasi Pengumuman Kelulusan SMK Negeri 7 Surakarta</span> 
                </div>
              </div>
              <!-- /Search -->

              <?php 
                    $nisn = htmlspecialchars($_SESSION['nisn']);
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <?php if(date("H:i:s") >= '06:00:00' && date("H:i:s") <= '10:00:00'){?>
                  <a href="#" class="btn btn-primary btn-sm"><i class="bx bx-sun"></i> &nbspSelamat Pagi, <?php echo $data['nama']?></a> 
                  <?php } else if(date("H:i:s") >= '10:00:01' && date("H:i:s") <= '14:00:00'){?>
                  <a href="#" class="btn btn-primary btn-sm"><i class="bx bxs-sun"></i> &nbspSelamat Siang, <?php echo $data['nama']?></a>
                  <?php } else if(date("H:i:s") >= '14:00:01' && date("H:i:s") <= '18:00:00'){?>
                  <a href="#" class="btn btn-primary btn-sm"><i class="bx bxs-sun"></i> &nbspSelamat Sore, <?php echo $data['nama']?></a>  
                  <?php } else if(date("H:i:s") >= '18:00:01'){?>
                    <a href="#" class="btn btn-primary btn-sm"><i class="bx bxs-moon"></i> &nbspSelamat Malam, <?php echo $data['nama']?></a> 
                <?php } else { 
                  echo '' ;
                }?>
                </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a
                    ...
                    <div class="avatar avatar-online">
                      <img src="../assets/Sneat/assets/img/avatars/1.png" alt style="border-radius:50%;" />
                    </div>
                  </a>
