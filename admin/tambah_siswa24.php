...
$message = '*INFORMASI PENTING !*<br><br> Nama Lengkap : '.$nama.' <br> NISN : '.$nisn.' <br> Kelas : 7 <br> Tahun Ajaran : 2024/2025 <br><br> Berhasil diinputkan oleh '.$_SESSION['nama_lengkap']. ' di Aplikasi Rapor SMP Advent Surakarta.';
