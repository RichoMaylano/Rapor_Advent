<?php
$title = "Data Siswa Kelas 8 Tahun 2023/2024 | Aplikasi Rapor SMP Advent";
include "header.php";
?>
    <!-- Content wrapper -->
    <div class="content-wrapper">
        ...
        <div class="card p-5">
         ...
         <?php
			$qsiswa = mysqli_query($db_conn,"SELECT * FROM data_rapor WHERE tahun_pelajaran='2023/2024' AND tahun_masuk='2022/2023' ORDER BY nama ASC");
			$no = 1;
