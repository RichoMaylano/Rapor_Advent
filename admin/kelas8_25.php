<?php
$title = "Data Siswa Kelas 8 Tahun 2025/2026 | Aplikasi Rapor SMP Advent";
include "header.php";
?>
    <!-- Content wrapper -->
    <div class="content-wrapper">
        ...
        <?php
			$qsiswa = mysqli_query($db_conn,"SELECT * FROM data_rapor WHERE tahun_pelajaran='2025/2026' AND tahun_masuk='2024/2025' ORDER BY nama ASC");
			$no = 1;
