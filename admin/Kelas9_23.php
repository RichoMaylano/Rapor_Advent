<?php
$title = "Data Siswa Kelas 9 Tahun 2023/2024 | Aplikasi Rapor SMP Advent";
include "header.php";
?>
    <!-- Content wrapper -->
    <div class="content-wrapper">
        ...
        <?php
			$qsiswa = mysqli_query($db_conn,"SELECT * FROM data_rapor WHERE tahun_pelajaran='2023/2024' AND tahun_masuk='2021/2022' ORDER BY nama ASC");
			$no = 1;
