<?php
$title = "Data Siswa Kelas 8 Tahun 2024/2025 | Aplikasi Rapor SMP Advent";
include "header.php";
?>
    <!-- Content wrapper -->
    <div class="content-wrapper">
        ...
        <div class="card p-5">
         ...
         <?php
			$qsiswa = mysqli_query($db_conn,"SELECT * FROM data_rapor WHERE tahun_pelajaran='2024/2025' AND tahun_masuk='2023/2024' ORDER BY nama ASC");
			$no = 1;
			if(mysqli_num_rows($qsiswa) > 0){
                ...
                <tr>
                    ...
                    <td class="text-center">Kelas 8</td>
