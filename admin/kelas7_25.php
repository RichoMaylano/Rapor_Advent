<?php
$title = "Data Siswa Kelas 7 Tahun 2025/2026 | Aplikasi Rapor SMP Advent";
include "header.php";
?>
    <!-- Content wrapper -->
    <div class="content-wrapper">
        ...
        <div class="modal fade" id="add_siswa" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="card">
                        ...
                        <form action="tambah_siswa25.php" method="POST">
                        ...
                        <div class="mb-6">
                          ...
                          <input type="text" class="form-control" id="tahun_masuk" name="tahun_masuk" value="2025/2026"/>
                        </div>
        ...
        <?php
			$qsiswa = mysqli_query($db_conn,"SELECT * FROM data_rapor WHERE tahun_pelajaran='2025/2026' AND tahun_masuk='2025/2026' ORDER BY nama ASC");
			$no = 1;
